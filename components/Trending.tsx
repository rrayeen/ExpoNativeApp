      ...
      {play ? (
        ...
        >
          <ImageBackground
            ...
            className="w-52 h-72 rounded-[35px] my-5 relative flex justify-center items-center overflow-hidden shadow-lg shadow-black/40"
            resizeMode="cover"
          >
            <Image
              source={icons.play}
